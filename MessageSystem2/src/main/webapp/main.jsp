            ...
            <div class="inner">
               ...
               <c:choose>
					...
					<c:forEach var="m" items="${messageList}">
							<tr>
								<td><c:out value="${m.num_message.nextval}"/></td>
								<td><c:out value="${m.sendEmail}"/></td>
								<td><c:out value="${m.message}"/></td>
								<td><c:out value="${m.sysdate}"/></td>
							</tr>
							</c:forEach>
               	</table>
               		</c:otherwise>
            ...
            <section>
               <form action ="SendMessageCon" method="post">
                  <div class="field half first">
                     ...
                     <input type="text" name="sendEmail" value="${loginMember.email }" readonly id="name" placeholder="보내는 사람 이름" />
                  </div>
            ...
            <section class="split">
               ...
               <section>
                  <div class="contact-method">
                     ...
                     <c:choose>
                        <c:when test="${empty loginMember}">
                        <h1>로그인 한 전화번호를 출력해주세요</h1>
                     </c:when>
                     <c:otherwise>
                        <h1>${loginMember.tel}님 환영합니다</h1>
                     </c:otherwise>
                     </c:choose>
               ...
               <section>
                  <div class="contact-method">
                     ...
                     <c:choose>
                        <c:when test="${empty loginMember}">
                        <h1>로그인 한 집주소를 출력해주세요</h1>
                     </c:when>
                     <c:otherwise>
                        <h1>${loginMember.address}님 환영합니다</h1>
                     </c:otherwise>
                     </c:choose>
                     <!-- <if(m ==null) {%>
                     <a href="#">로그인 한 사람의 집주소를 출력</a>
                     <}else{%>
                     <a href="#"><=m.getAddress()%></a>
                     <} %> -->
